...
import '../../cubit/app_state_cubit.dart' as _i20;
...
import '../../pages/sign_in_page/cubit/sign_in_cubit.dart' as _i19;
import '../../pages/splash_page/cubit/splash_cubit.dart' as _i13;
import '../../pages/vehicles_page/cubit/vehicles_cubit.dart' as _i14;
...
import '../secure_storage_service.dart' as _i12;
import '../vehicles_service.dart' as _i15;
import 'injectible_init.dart' as _i21;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i17.AuthRepositoryI>(
      () => _i18.AuthRepositoryImplementation(gh<_i16.AuthDataSourceI>()));
  gh.factory<_i19.SignInCubit>(
      () => _i19.SignInCubit(gh<_i17.AuthRepositoryI>()));
  gh.factory<_i20.AppStateCubit>(() => _i20.AppStateCubit(
        authRepository: gh<_i17.AuthRepositoryI>(),
